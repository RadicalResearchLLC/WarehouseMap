# Warehouse CITY Documentation (beta v1.15 - released July 13, 2023)
...
- **Planned and approved warehouses** - Polygons for these projects are manually entered by multiple individuals and may not be representative of final parcel boundaries. These are a good faith effort  at representing the locations and boundaries of planned warehouse projects but should not be solely relied upon as a source of boundary locations. The authors of this tool do not 
...
The information provided on this dashboard is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, validity, or completeness of any information on the site.  Use of this site or reliance on this data is at the user's discretion and we have no liability for any loss or damage incurred as a result of the use of this data with its disclosed and unknown limitations.   
